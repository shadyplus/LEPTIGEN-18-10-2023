...
let now = new Date,
    ...
    date = day + "." + mm + "." + year;
const massange = [{
    m: "مرحباً ، إسمي منال السيد . أنا أخصائية تغذية . مرحبا بكم في موقع الويب الخاص بي. "
}, {
    m: "هنا أقدم تشخيصات مجانية عبر الإنترنت نصائح شخصية ساعدت الكثير من الأشخاص على التخلص من الوزن الزائد. "
}, {
    ...
    m: "و لذلك  " + OFFER + " يُكسر ويُزيل الدهون الحشوية بشكل فعال للغاية ، التي تبطن جدران الأعضاء الداخلية وتمنعها من العمل بشكل صحيح ، و أيضاً  LEPTIGEN   ينشط عملية التمثيل الغذائي عن طريق تطهير الجسم من السموم والشوائب. "
}, {
    ...
    m: 'هذه بعض النتائج للناس اللذين فقدوا وزنهم بنجاح بإستخدام هذا المكمل الغذائي LEPTIGEN  : <br> <br><img src="img/comm-photo3-135-arb.jpg"> <br> <img src="img/comm2-92a-arb.jpg"> <br> <img src="img/comm6-abb-arb.jpg"> '
}, {
